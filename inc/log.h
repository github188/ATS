...
#define ats_log_fatal(fmt, args...)  \
    ats_log_write(ATS_LOG_FATAL, __FILE__, __LINE__, fmt, ##args)
#define ats_log_error(fmt, args...)  \
    ats_log_write(ATS_LOG_ERROR, __FILE__, __LINE__, fmt, ##args)
#define ats_log_warn(fmt, args...)  \
    ats_log_write(ATS_LOG_WARN, __FILE__, __LINE__, fmt, ##args)
#define ats_log_info(fmt, args...)  \
    ats_log_write(ATS_LOG_INFO, __FILE__, __LINE__, fmt, ##args)
#define ats_log_debug(fmt, args...)  \
    ats_log_write(ATS_LOG_DEBUG, __FILE__, __LINE__, fmt, ##args)
